class Autocomplete {
  ...
  getMatches(matchedString) {
    const optionElements = Array.from(this.input.options);
    const filteredArray = optionElements.filter(element => element.text.includes(matchedString));
    let resultArray = [];
